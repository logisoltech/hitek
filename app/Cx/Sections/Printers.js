...
const Printers = () => {
  ...
  const products = [
    ...
    {
      name: 'Canon PIXMA-G1010 Ink Tank Printer, Print, Scan, Copy.',
      price: '50,300',
      rating: 4.5,
      reviews: 536,
      image: '/printer-category.png'
    ...
    {
      name: 'HP LASERJET DRUM UNIT 1104A Cartridge Colors: Black.',
      price: '20,000',
      rating: 4.5,
      reviews: 583,
      image: '/toner-category.jpg',
      label: { text: 'SALE', color: 'bg-green-500' }
    },
    {
      name: 'EPSON A3 COLOUR PRINTER L18050 (6 COLOUR)',
      price: '112,300',
      rating: 4.5,
      reviews: 536,
      image: '/printer-category.png'
